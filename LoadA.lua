...
local l_ModuleScriptLoader_0 = require(game:GetService("ReplicatedStorage").Sonar:WaitForChild("ModuleScriptLoader"));
local l_ReplicationUtils_0 = require(game:GetService("ReplicatedStorage").Sonar:WaitForChild("ReplicationUtils"));
