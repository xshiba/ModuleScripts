...
local l_ClickSound_0 = game:GetService("ReplicatedStorage")._replicationFolder.Button3D.ClickSound
local l_HeavyHoverSound_0 = game:GetService("ReplicatedStorage")._replicationFolder.Button3D.HeavyHoverSound
local v10 = {
    Heavy = l_HeavyHoverSound_0, 
    Light = game:GetService("ReplicatedStorage")._replicationFolder.Button3D.LightHoverSound
};
